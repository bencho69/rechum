      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Cumpleaños Ruben A.</h4>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Teléfono Dr. Alma Villaseñor</h4>

                <p>Teléfono +5(800)555-1234</p>
              </div>
            </a>
          </li>
          <li>
        ...
        <ul class="control-sidebar-menu">
          ...
          <li>
            <a href="javascript:void(0)">
              <h4 class="control-sidebar-subheading">
                Avance Sistema de Peticiones
                <span class="label label-success pull-right">11%</span>
              </h4>
